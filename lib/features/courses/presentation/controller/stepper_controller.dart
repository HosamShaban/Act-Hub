...
import 'package:acthub/features/courses/presentation/view/widget/course_item.dart';
                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ManagerString.paymentSuccessful,
  ...
  Future<void> nextStep() async {
    ...
    if (currentStep < steps.length - 1) {
      if (!(currentStep == secondStepIndex && paymentMethodId == -1)) {
        ...
        dialogRender(
            context: context,
            message: ManagerString.pleaseSelectPaymentMethod,
            title: '',
            stateRenderType: StateRenderType.popUpErrorState,
            retryAction: () {
              Get.back();
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ManagerString.personalInformation,
