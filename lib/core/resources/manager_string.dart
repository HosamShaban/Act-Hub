...
class ManagerString {
  ...
  static String get myAppointment => tr('myAppointment');
  ...
  static String get noContent => tr('NO_CONTENT');

  static String get badRequest => tr('BAD_REQUEST');

  static String get forbidden => tr('FORBIDDEN');

  static String get unauthorised => tr('UNAUTHORISED');

  static String get botFound => tr('NOT_FOUND');

  static String get internalServerError => tr('INTERNAL_SERVER_ERROR');

  static String get connectTimeout => tr('CONNECT_TIMEOUT');
  ...
  static String get weak => tr('weak');
  ...
  static String get haveNotAccount => tr('haveNotAccount');

  static String get haveAccount => tr('haveAccount');

  static String get requiredFullName => tr('requiredFullName');

  static String get requiredPhone => tr('Required Phone');

  static String get courseRatingSuccessfully => tr('courseRatingSuccessfully');
}
